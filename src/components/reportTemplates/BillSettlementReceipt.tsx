...
import { PatientAdvancePaymentModeItem } from "@/screens/patientAdvance/types";
...
export default function BillSettlementReceipt({
  printOnMount = false,
  patientDetails,
  paymentModeList,
}: {
  printOnMount?: boolean;
  patientDetails: IpdPatientAdvanceItem | null;
  ...
  const isRefundReceipt = Number((patientDetails?.Amount ?? 0) < 0 ? 1 : 0) === 1;
    ...
    <div id="patient-advance-receipt-print-wrapper">
      ...
      >
        ...
        >
          ...
          >
            {isRefundReceipt ? "IPD Patient Refund Receipt" : "IPD Patient Advance Receipt"}
          </div>
              ...
              <table style={{ width: "100%", fontSize: "14px" }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ verticalAlign: "top" }}>: {patientDetails?.GuardianName}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table style={{ width: "100%", fontSize: "14px" }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ verticalAlign: "top" }}>: {patientDetails?.Remarks ?? ""}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div style={{ fontWeight: "bold", marginBottom: "15px", fontSize: "14px" }}>
              ...
              {numberToWords(Number(patientDetails?.Amount))} .
            </div>

            <div style={{ fontWeight: "bold", marginBottom: "15px", fontSize: "14px" }}>
              Total Amount: {`₹ ${patientDetails?.Amount}`}
            </div>
          </div>
