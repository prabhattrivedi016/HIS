...
export type CorporateTransferApprovalFilterValues = {
  branchId: number;
  fromDate: string;
  toDate: string;
};
...
const CorporateTransferFilterPopup = ({
  isOpen,
  onClose,
  onApply,
  initialValues,
  branchList = [],
  modalTitle = "Filter Corporate Transfer Confirmation",
}: {
  isOpen: boolean;
  onClose: () => void;
  onApply: (values: CorporateTransferApprovalFilterValues) => void;
  initialValues: CorporateTransferApprovalFilterValues;
  branchList?: BranchOption[];
  modalTitle?: string;
}) => {
  const [filterValues, setFilterValues] =
    useState<CorporateTransferApprovalFilterValues>(initialValues);
...
export default CorporateTransferFilterPopup;
