...
export default function RevenueTrendChart() {
  ...
  // Values scaled up to 5K max scale
  const sales = [1.5, 2.2, 2.8, 3.5, 4.1, 4.6];
  const collection = [1.8, 2.5, 3.2, 3.9, 4.4, 4.9];

  const maxValue = 5; // Scale up to 5K
  ...
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-5 border border-gray-200 shadow-2xs flex flex-col justify-between w-full">
      ...
      <div className="flex items-center justify-between mb-4 gap-2 min-w-0">
        <h3 className="text-xs sm:text-sm font-bold text-gray-800 flex items-center min-w-0 truncate">
          ...
          <span className="truncate">
            Monthly Investigation Trend (Last 6 Month)
          </span>
        </h3>
      ...
      {/* ================= LEGEND ================= */}
      <div className="flex items-center justify-center gap-3 mt-4 pt-2 border-t border-gray-100 text-xs font-semibold flex-wrap">
