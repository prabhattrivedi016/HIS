import { ArrowUp, ArrowDown, BedDouble, IndianRupee } from "lucide-react";

export default function MetricsOverviewRow() {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-3 px-3 py-3 bg-[#f8fafc]">
      {/* =====================================================
          1. TOTAL BEDS
          ===================================================== */}
        ...
        <div className="flex items-center justify-between min-w-0">
          ...
          <div className="flex flex-col items-center shrink-0 ml-1">
            <div className="relative w-[50px] h-[50px] flex items-center justify-center">
              ...
              <span className="absolute text-[10px] font-extrabold text-gray-700">
                78%
              </span>
            </div>
