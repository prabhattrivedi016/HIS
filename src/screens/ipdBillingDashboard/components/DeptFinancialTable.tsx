        ...
        <table className="w-full min-w-[450px] table-fixed border-collapse text-left text-[10px] sm:text-[11px]">
          <thead>
            <tr className="bg-gray-50 text-gray-500 font-bold uppercase text-[9px] sm:text-[10px] tracking-wider">
              <th className="w-[22%] border border-gray-300 py-2.5 px-2 break-words">
                Department
              </th>
              <th className="w-[20%] border border-gray-300 py-2.5 px-2 break-words">
                Revenue (₹)
              </th>
              <th className="w-[20%] border border-gray-300 py-2.5 px-2 break-words">
                Expense (₹)
              ...
              <th className="w-[18%] border border-gray-300 py-2.5 px-2 break-words">
                Collection Rate
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-100 font-semibold text-gray-700">
            {departments.map((row) => (
              ...
              >
                <td className="border border-gray-300 py-2.5 px-2 font-bold text-gray-900 break-words">
                  {row.name}
                </td>
                <td className="border border-gray-300 py-2.5 px-2 break-words">
                  {row.rev}
                </td>
                <td className="border border-gray-300 py-2.5 px-2 text-gray-600 break-words">
                  {row.exp}
                </td>
                <td className="border border-gray-300 py-2.5 px-2 font-bold text-blue-600 break-words">
                  {row.net}
                </td>
          ...
          <tfoot>
            <tr className="bg-gray-50/75 font-extrabold text-gray-900">
              ...
              <td className="border border-gray-300 py-2.5 px-2 text-blue-700 break-words">
                1,30,08,700
              </td>
              <td className="border border-gray-300 py-2.5 px-2">
