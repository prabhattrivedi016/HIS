...
const OpdPackageMaster = () => {
  ...
  useEffect(() => {
    ...
    const selected = categoryList.find((c: CategoryItem) => Number(c?.categoryTypeId) === 11);
  ...
  return (
    <div className="page-container">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 mb-1">
        <div>
          <h1 className="page-heading">OPD Package Master</h1>
...
export default OpdPackageMaster;
