...
const WriteOffViewDetailsPopup = ({
  ...
  const getApprovalDetails = async () => {
    const resp = await fetchApi(
      "GET",
      ENDPOINTS.GET_WRITE_OFF_REQUEST_APPROVAL_DETAILS,
      {},
  ...
  const patientDetails = [
    ...
    { label: "Bill No", value: approvalDetails?.BillNo },
  ...
  const billingDetails = [
    ...
    { label: "Total Write Off Amount", value: approvalDetails?.TotalWriteOffAmount },

    { label: "Write Off Approved Name", value: approvalDetails?.WriteOffApprovedName },
    { label: "Write Off Reason", value: approvalDetails?.WriteOffReason },
    { label: "Write Off Remark", value: approvalDetails?.WriteOffRemark },
  ];
          ...
          <div className="card w-full mb-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 mb-1">
              ...
              <div className="flex flex-row gap-1">
                ...
                <span className="truncate">
                  {formatValue(approvalDetails?.IsWriteOffApproved === 1 ? "Yes" : "No")}
                </span>
              </div>
            </div>
