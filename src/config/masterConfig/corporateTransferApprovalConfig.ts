export const corporateTransferApprovalConfig = {
  type: "corporateTransferApproval",

  gridCardView: {
    type: "corporateTransferApproval",
    cardType: "corporateTransferApprovalGrid",
    cardViewType: "grid",
    ...
    gridButtonSection: [
      { label: "Approve", action: "toggleCorporateTransferApprove" },
  ...
  listCardView: {
    type: "corporateTransferApproval",
    cardType: "corporateTransferApprovalList",
    cardViewType: "list",
    ...
    listLeftButton: [
      {
        label: "Action",
        action: "toggleCorporateTransferApproval",
      },
    ],
